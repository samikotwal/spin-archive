      ...
      >
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-6">
            {/* Logo */}
            <motion.h1 
              className="text-2xl font-black text-foreground shrink-0 flex items-center gap-2"
            ...
            <div className="flex-1 max-w-lg relative">
              ...
              >
                <Input
                  ...
                  className="pl-4 pr-12 py-3 bg-secondary/80 border-white/10 rounded-lg focus:ring-2 focus:ring-primary transition-all"
                />
                {searchQuery ? (
                  <motion.div
              ...
              {user ? (
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button
                    ...
                    className="bg-gradient-to-r from-primary to-accent text-white font-bold rounded-lg"
                  >
            ...
            <div className="relative">
              ...
              <div className="absolute top-4 left-1/2 -translate-x-1/2 z-20">
                <motion.div 
                  ...
                  className="flex items-center gap-2 glass rounded-full px-2 py-1"
                >
                  {navTabs.map((tab) => (
                    <motion.button
                      key={tab.id}
